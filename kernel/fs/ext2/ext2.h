...
typedef struct {
  ...
  uint32_t direct_block_ptr_1;
  uint32_t direct_block_ptr_2;
  uint32_t direct_block_ptr_3;
  uint32_t direct_block_ptr_4;
  uint32_t direct_block_ptr_5;
  uint32_t direct_block_ptr_6;
  uint32_t direct_block_ptr_7;
  uint32_t direct_block_ptr_8;
  uint32_t direct_block_ptr_9;
  uint32_t direct_block_ptr_10;
  uint32_t direct_block_ptr_11;
