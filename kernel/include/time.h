...
*/
_PDCLIB_PUBLIC size_t strftime(char *_PDCLIB_restrict s, size_t maxsize,
...
*/
_PDCLIB_PUBLIC errno_t asctime_s(char *s, rsize_t maxsize,
...
/* Converts the calender time pointed to by timer into a broken-down time
   ...
   (see set_constraint_handler_s()).
*/
_PDCLIB_PUBLIC struct tm *gmtime_s(const time_t *_PDCLIB_restrict timer,
                                   struct tm *_PDCLIB_restrict result);
...
/* Converts the calender time pointed to by timer into a broken-down time
   ...
   (see set_constraint_handler_s()).
*/
_PDCLIB_PUBLIC struct tm *localtime_s(const time_t *_PDCLIB_restrict timer,
                                      struct tm *_PDCLIB_restrict result);
