...
_PDCLIB_PUBLIC void _PDCLIB_assert99(const char *const, const char *const,
                                     const char *const);
...
#define assert(expression)                                                     \
  ((expression)                                                                \
       ? (void)0                                                               \
       : _PDCLIB_assert99("Assertion failed: " #expression ", function ",      \
                          __func__,                                            \
                          ", file " __FILE__                                   \
...
#define assert(expression)                                                     \
  ((expression)                                                                \
       ? (void)0                                                               \
       : _PDCLIB_assert89("Assertion failed: " #expression ", file " __FILE__  \
                          ", line " _PDCLIB_value2string(__LINE__) ".\n"))
#endif
#endif
