...
#define PRIdLEAST8                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST8_PREFIX, d))
#define PRIdLEAST16                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST16_PREFIX, d))
#define PRIdLEAST32                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST32_PREFIX, d))
#define PRIdLEAST64                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST64_PREFIX, d))

#define PRIdFAST8                                                              \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST8_PREFIX, d))
#define PRIdFAST16                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST16_PREFIX, d))
#define PRIdFAST32                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST32_PREFIX, d))
#define PRIdFAST64                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST64_PREFIX, d))
...
#define PRIiLEAST8                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST8_PREFIX, i))
#define PRIiLEAST16                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST16_PREFIX, i))
#define PRIiLEAST32                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST32_PREFIX, i))
#define PRIiLEAST64                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST64_PREFIX, i))

#define PRIiFAST8                                                              \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST8_PREFIX, i))
#define PRIiFAST16                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST16_PREFIX, i))
#define PRIiFAST32                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST32_PREFIX, i))
#define PRIiFAST64                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST64_PREFIX, i))
...
#define PRIoLEAST8                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST8_PREFIX, o))
#define PRIoLEAST16                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST16_PREFIX, o))
#define PRIoLEAST32                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST32_PREFIX, o))
#define PRIoLEAST64                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST64_PREFIX, o))

#define PRIoFAST8                                                              \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST8_PREFIX, o))
#define PRIoFAST16                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST16_PREFIX, o))
#define PRIoFAST32                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST32_PREFIX, o))
#define PRIoFAST64                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST64_PREFIX, o))
...
#define PRIuLEAST8                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST8_PREFIX, u))
#define PRIuLEAST16                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST16_PREFIX, u))
#define PRIuLEAST32                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST32_PREFIX, u))
#define PRIuLEAST64                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST64_PREFIX, u))

#define PRIuFAST8                                                              \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST8_PREFIX, u))
#define PRIuFAST16                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST16_PREFIX, u))
#define PRIuFAST32                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST32_PREFIX, u))
#define PRIuFAST64                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST64_PREFIX, u))
...
#define PRIxLEAST8                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST8_PREFIX, x))
#define PRIxLEAST16                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST16_PREFIX, x))
#define PRIxLEAST32                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST32_PREFIX, x))
#define PRIxLEAST64                                                            \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_LEAST64_PREFIX, x))

#define PRIxFAST8                                                              \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST8_PREFIX, x))
#define PRIxFAST16                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST16_PREFIX, x))
#define PRIxFAST32                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST32_PREFIX, x))
#define PRIxFAST64                                                             \
  _PDCLIB_value2string(_PDCLIB_concat(_PDCLIB_INT_FAST64_PREFIX, x))
...
*/
_PDCLIB_PUBLIC intmax_t strtoimax(const char *_PDCLIB_restrict nptr,
                                  char **_PDCLIB_restrict endptr, int base);
_PDCLIB_PUBLIC uintmax_t strtoumax(const char *_PDCLIB_restrict nptr,
                                   char **_PDCLIB_restrict endptr, int base);
